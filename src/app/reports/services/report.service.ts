...
export class ReportService {
      ...
      const sampleReports: Report[] = [
        {
          ...
          description: 'Se ha formado un bache de aproximadamente 1 metro de diámetro en la avenida principal de Echarati, cerca del cruce con la calle Quillabamba. Representa peligro para vehículos y peatones.',
        ...
        },
        {
          ...
          description: 'Tres postes de alumbrado público no funcionan en el perímetro de la Plaza de Armas de Echarati. La zona queda completamente oscura después de las 6pm, generando inseguridad.',
        ...
        },
        {
          ...
          description: 'Se ha acumulado basura en las inmediaciones del mercado central de Echarati durante más de tres días. Genera malos olores y atrae insectos. Se requiere recojo urgente y colocación de contenedores.',
        ...
        },
        {
          ...
          description: 'El puente peatonal que cruza el río Urubamba cerca del sector Palma Real presenta tablas rotas y barandales sueltos. Es usado diariamente por estudiantes y agricultores de la zona.',
          category: ReportCategory.INFRASTRUCTURE,
        ...
        },
        {
          ...
          description: 'En el kilómetro 15 de la carretera Echarati-Quillabamba falta señalización en una curva cerrada donde ya han ocurrido accidentes. Se necesitan señales de velocidad y espejos convexos.',
        ...
        },
        {
          ...
          description: 'Se observa agua de color oscuro y mal olor en la quebrada Chaupimayo, posiblemente por vertido de residuos. Afecta a las familias que utilizan esta fuente de agua para riego y consumo.',
          category: ReportCategory.ENVIRONMENT,
        ...
        },
        {
          ...
          description: 'La vereda frente al centro de salud de Echarati está completamente destruida. Los pacientes y personas con discapacidad tienen dificultades para acceder al establecimiento. Se necesita reconstrucción urgente.',
          category: ReportCategory.INFRASTRUCTURE,
      ...
      map(reports => {
        ...
        if (filter) {
          result = result.filter(report => {
            ...
            if (filter.startDate && report.createdAt && report.createdAt < filter.startDate) return false;
            if (filter.endDate && report.createdAt && report.createdAt > filter.endDate) return false;
            return true;
          });
        }
   ...
   */
  getStats(): { total: number; pending: number; inProgress: number; resolved: number; closed: number } {
    return {
